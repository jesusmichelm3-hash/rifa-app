        ...
        <main className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white p-6">
            ...
            <div className="bg-white rounded-3xl p-8 text-center shadow-2xl mb-8">
                ...
                <div className="text-center mt-4 leading-tight">
                    ...
                    <h1 className="text-[#6b6a5a] text-3xl md:text-6xl font-extrabold tracking-wide">
                        🎉 ¡GRAN RIFA! 🎉
                    </h1>

                    <p className="text-[#6b6a5a] text-3xl md:text-5xl font-extrabold">
                        💰 20,000 PESOS 💰
                    </p>

                    <p className="text-[#6b6a5a] text-base md:text-xl font-semibold">
                        🎟 Boletos ya disponibles
                    </p>

                    <p className="text-[#6b6a5a] text-lg md:text-3xl font-bold">
                        💵 Solo $20 MXN por boleto
                    </p>

                    <p className="text-[#6b6a5a] text-xs md:text-sm opacity-80">
                ...
                <div className="bg-white rounded-2xl p-5 text-center mb-8 max-w-3xl mx-auto shadow-xl">
                    ...
                    <div className="overflow-x-auto flex gap-4 snap-x snap-mandatory pb-4">
                        ...
                        {avisos.map((aviso, index) => (
                            ...
                            <div
                                key={index}
                                className="min-w-[280px] md:min-w-[350px] snap-center bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-5 shadow-md border text-[#6b6a5a] flex items-center justify-center text-center font-semibold"
                            >
